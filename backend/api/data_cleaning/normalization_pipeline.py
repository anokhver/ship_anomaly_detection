...
from utils.normalization_utils import clean_destination, match_names
...
def destination_normalization(
        file_path: str = 'data_to_clean/1_merged_typed_data.parquet',
        output_path: str = 'data_to_clean/2_destination_norm.parquet',
        verbose: bool = False,
