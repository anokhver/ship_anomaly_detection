...
| Task                                       | Description                                                            | Responsible                                           | Estimated Time | Time Spent | Dependency           |
|--------------------------------------------|------------------------------------------------------------------------|-------------------------------------------------------|----------------|------------|----------------------|
...
| **3. Group Session**                       | Consensus on anomalies + review data analysis                          | All                                                   | 1.5h           | -          | ST01                 |
| **4. Develop cleaning pipeline - {ST02}**  | Missing value handling, error removal, drop attributes                 | @cgy3920 (Veronika)                                   | 9h (4h+3h+2h)  | -          | ST01 complete & 2, 3 |
...
| Task                                    | Description                                                 | Responsible                | Estimated Time | Time Spent | Dependency                                |
|-----------------------------------------|-------------------------------------------------------------|----------------------------|----------------|------------|-------------------------------------------|
| **1. Implement noise removal - {ST02}** | Remove noise data, play with the threshold of what is noise | @coz1686 (Piotr Ciupiński) | 6h (3h+3h)     | -          | Week 1 ST02 complete                      |
| **2. Label sample trips - {ST04}**      | Apply definitions, revise labels, document process          | Everyone                   | 10h (5h+3h+2h) | -          | Week 1 ST04 finalized + ST02 cleaned data |
| **3. Integrate tools - {ST03}**         | Docker setup for selected tools                             | @coz1686 (Piotr Ciupiński) | 3h             | -          | Week 1 ST03 research done                 |
| **4. Cleanup repository**               | Organize code/docs, final checks                            | @cgy3920 (Veronika)        | 1h             | -          | All other tasks complete                  |
